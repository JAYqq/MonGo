  ...
  <div class="container">
    ...
    <div class="card border-0 g-mb-15">
      ...
      >
        <h3 class="h6 mb-0">
          ...
          <small
            v-if="posts"
          >(共 {{ posts._meta.total_items }} 篇, {{ posts._meta.total_pages }} 页)</small>
        </h3>
        <div class="dropdown g-mb-10 g-mb-0--md">
          ...
          <div class="dropdown-menu dropdown-menu-right rounded-0 g-mt-10">
            ...
            <router-link
              v-bind:to="{ name: 'Home', query: { page: 1, per_page: 1 }}"
              class="dropdown-item g-px-10"
            >
      ...
      <div v-if="posts" class="card-block g-pa-0">
        ...
        >
          <router-link
            v-bind:to="{ name: 'UserOverview', params: { id: post.author.id }}"
          ...
          <div class="media-body">
            ...
            >
              ...
              <div class="text-nowrap g-font-size-12">
                ...
                <router-link v-bind:to="{ name: 'UserOverview', params: { id: post.author.id }}">
    ...
    <nav v-if="posts" aria-label="Page Navigation" class="g-mb-50">
      <ul class="list-inline">
        ...
        >
          <router-link
            v-bind:to="{ name: 'Home', query: { page: page, per_page: posts._meta.per_page }}"
        ...
        <li class="list-inline-item float-right">
          <span
            class="u-pagination-v1__item-info g-pa-12-19"
          >Page {{ posts._meta.page }} of {{ posts._meta.total_pages }}</span>
        </li>
      </ul>
    </nav>
    <!-- End Pagination #04 -->
  ...
  methods: {
    getPosts() {
      ...
      .then((response)=>{
        ...
        this.iter_pages=[...new Set(arr)]//[...new Set()]是重新将去重的数据转换成数组形式的方法
    ...
    onEditPost(post){
      ...
      this.editForm=Object.assign({},post)//这个方法可以用于对象的合并:{a:1}和{b:2}变成{a:1,b:2}
    },
    onSubmitUpdate(){
