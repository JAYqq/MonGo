        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            ...
            <ul class="nav nav-tabs g-mb-20">
              ...
              <li class="nav-item">
                <router-link v-bind:to="{ name: 'UserPostsList' }" v-bind:active-class="'active'" class="nav-link" v-bind:class="{'active': $route.name == 'UserFollowingPosts'}">Posts <span class="u-label g-font-size-11 g-bg-purple g-rounded-20 g-px-10">{{ user.posts_count }}</span></router-link>
              </li>
            </ul>
